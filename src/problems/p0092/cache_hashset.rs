...
fn check_chains(n: i64, set1: &mut HashSet<i64>, set89: &mut HashSet<i64>) -> bool {
    let mut m = n;
...
pub fn solve() -> i64 {
    ...
    let mut set1 = HashSet::with_capacity(LIMIT as usize);
    let mut set89 = HashSet::with_capacity(LIMIT as usize);
    set1.insert(1);
    set89.insert(89);
